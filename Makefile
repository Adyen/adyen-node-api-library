...
services:=checkout storedValue terminalManagement payments recurring payouts platformsAccount platformsFund platformsNotificationConfiguration platformsHostedOnboardingPage  
