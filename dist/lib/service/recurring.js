...
var Recurring = /** @class */ (function (_super) {
    ...
    Recurring.prototype.listRecurringDetails = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._listRecurringDetails, request)];
    ...
    Recurring.prototype.disable = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._disable, request)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
