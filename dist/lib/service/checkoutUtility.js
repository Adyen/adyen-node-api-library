...
var CheckoutUtility = /** @class */ (function (_super) {
    ...
    function CheckoutUtility(client) {
        ...
        _this._originKeys = new originKeys_1.default(_this);
        return _this;
    }
    CheckoutUtility.prototype.originKeys = function (originKeysRequest) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getJsonResponse_1.default(this._originKeys, originKeysRequest)];
            });
        });
    };
    return CheckoutUtility;
}(apiKeyAuthenticatedService_1.default));
exports.default = CheckoutUtility;
