...
var BinLookup = /** @class */ (function (_super) {
    ...
    BinLookup.prototype.get3dsAvailability = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._get3dsAvailability, request)];
    ...
    BinLookup.prototype.getCostEstimate = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._getCostEstimate, request)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
