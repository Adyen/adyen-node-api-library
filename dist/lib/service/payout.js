...
var Payout = /** @class */ (function (_super) {
    ...
    Payout.prototype.storeDetailAndSubmitThirdParty = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._storeDetailAndSubmitThirdParty, request)];
    ...
    Payout.prototype.confirmThirdParty = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._confirmThirdParty, request)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Payout.prototype.declineThirdParty = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._declineThirdParty, request)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Payout.prototype.storeDetail = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._storeDetail, request)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Payout.prototype.submitThirdparty = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse_1.default(this._submitThirdParty, request)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
