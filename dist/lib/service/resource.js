            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        apiException = new apiException_1.default(e_1.message, e_1.code);
                        return [3 /*break*/, 4];
                    case 4:
                        try {
                            ...
                            throw new apiException_1.default("Invalid response or an invalid X-API-Key key was used", e.statusCode);
                        }
                        throw apiException;
                }
            });
