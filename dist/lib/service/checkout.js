...
var Checkout = /** @class */ (function (_super) {
    ...
    Checkout.prototype.payments = function (paymentsRequest, requestOptions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getJsonResponse_1.default(this._payments, paymentsRequest, requestOptions)];
            });
        });
    };
    Checkout.prototype.paymentMethods = function (paymentMethodsRequest) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getJsonResponse_1.default(this._paymentMethods, paymentMethodsRequest)];
            });
        });
    };
    Checkout.prototype.paymentsDetails = function (paymentsDetailsRequest) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getJsonResponse_1.default(this._paymentsDetails, paymentsDetailsRequest)];
            });
        });
    };
    Checkout.prototype.paymentSession = function (paymentSessionRequest, requestOptions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getJsonResponse_1.default(this._paymentSession, paymentSessionRequest, requestOptions)];
            });
        });
    };
    Checkout.prototype.paymentResult = function (paymentResultRequest) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getJsonResponse_1.default(this._paymentsResult, paymentResultRequest)];
            });
        });
    };
    return Checkout;
