...
var TerminalLocalAPI = /** @class */ (function (_super) {
    ...
    function TerminalLocalAPI(client) {
        ...
        _this.localRequest = new localRequest_1.default(_this);
        _this.nexoCrypto = new nexoCrypto_1.default();
        return _this;
    }
    TerminalLocalAPI.prototype.request = function (terminalApiRequest, securityKey) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        saleToPoiSecuredMessage = nexoCrypto_1.default.encrypt(terminalApiRequest.saleToPoiRequest.messageHeader, terminal_1.Convert.terminalApiRequestToJson(terminalApiRequest), securityKey);
