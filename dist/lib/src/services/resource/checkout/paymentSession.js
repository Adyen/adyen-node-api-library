...
var PaymentSession = (function (_super) {
    __extends(PaymentSession, _super);
    function PaymentSession(service) {
        return _super.call(this, service, service.client.config.checkoutEndpoint + "/" + client_1.default.CHECKOUT_API_VERSION + "/paymentSession") || this;
    }
