...
var AdjustAuthorisation = (function (_super) {
    ...
    function AdjustAuthorisation(service) {
        return _super.call(this, service, service.client.config.endpoint + "/pal/servlet/Payment/" + client_1.default.API_VERSION + "/adjustAuthorisation") || this;
    }
    return AdjustAuthorisation;
}(resource_1.default));
exports.default = AdjustAuthorisation;
