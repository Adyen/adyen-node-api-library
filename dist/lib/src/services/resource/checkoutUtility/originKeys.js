...
var OriginKeys = (function (_super) {
    ...
    function OriginKeys(service) {
        return _super.call(this, service, service.client.config.checkoutEndpoint + "/" + client_1.default.CHECKOUT_UTILITY_API_VERSION + "/originKeys") || this;
    }
    return OriginKeys;
}(resource_1.default));
exports.default = OriginKeys;
