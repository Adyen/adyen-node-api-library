...
var getResponse = function (_a, cb) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    client = new client_1.default({ apiKey: apiKey, environment: environment });
                    ...
                    ErrorException = errorType === "ApiException" ? apiException_1.default : httpClientException_1.default;
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
