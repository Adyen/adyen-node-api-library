...
export declare namespace DeviceRenderOptions {
    ...
    const SdkInterfaceEnum: {
        Html: SdkInterfaceEnum;
        Native: SdkInterfaceEnum;
        Both: SdkInterfaceEnum;
    };
    type SdkUiTypeEnum = 'multiSelect' | 'otherHtml' | 'outOfBand' | 'singleSelect' | 'text';
    const SdkUiTypeEnum: {
        MultiSelect: SdkUiTypeEnum;
        OtherHtml: SdkUiTypeEnum;
        OutOfBand: SdkUiTypeEnum;
        SingleSelect: SdkUiTypeEnum;
        Text: SdkUiTypeEnum;
    };
}
