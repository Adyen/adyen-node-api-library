...
export declare namespace PaymentVerificationResponse {
    ...
    const ResultCodeEnum: {
        AuthenticationFinished: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        Authorised: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        Cancelled: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        ChallengeShopper: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        Error: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        IdentifyShopper: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        Pending: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        Received: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        RedirectShopper: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
        Refused: import("./paymentResponse").PaymentResponse.ResultCodeEnum;
    };
}
