...
export declare namespace ModificationResult {
    type ResponseEnum = '[capture-received]' | '[cancel-received]' | '[refund-received]' | '[cancelOrRefund-received]';
    const ResponseEnum: {
        CaptureReceived: ResponseEnum;
        CancelReceived: ResponseEnum;
        RefundReceived: ResponseEnum;
        CancelOrRefundReceived: ResponseEnum;
    };
}
