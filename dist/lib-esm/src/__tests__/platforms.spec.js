...
describe("Platforms Test", function () {
    describe("Account", function () {
        describe("Accounts", function () {
            var _this = this;
            var cases = [
                ["closeAccount", createMock(), createMock(), "accounts"],
                ["updateAccount", createMock(), createMock(), "accounts"],
                ["createAccount", createMock(), createMock(), "accounts"],
                ["uploadDocument", createMock(), createMock(), "verification"],
                ["getUploadedDocuments", createMock(), createMock(), "verification"],
                ["deleteBankAccounts", createMock(), createMock(), "verification"],
                ["deletePayoutMethods", createMock(), createMock(), "verification"],
                ["deleteShareholders", createMock(), createMock(), "verification"],
                ["checkAccountHolder", createMock(), createMock(), "verification"],
                ["createAccountHolder", createMock(), createMock(), "accountHolders"],
                ["getAccountHolder", createMock(), createMock(), "accountHolders"],
                ["updateAccountHolder", createMock(), createMock(), "accountHolders"],
                ["suspendAccountHolder", createMock(), createMock(), "accountHolders"],
                ["unSuspendAccountHolder", createMock(), createMock(), "accountHolders"],
                ["closeAccountHolder", createMock(), createMock(), "accountHolders"],
            ];
