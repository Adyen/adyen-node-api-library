...
| [Checkout API](https://docs.adyen.com/api-explorer/Checkout/72/overview)                                   |     v72     | Our latest integration for accepting online payments.                                                                                                                                                                                                                                                                                    | [CheckoutAPI](/src/services/checkout/index.ts)                                                                                                                          |
| [Capital API](https://docs.adyen.com/api-explorer/capital/1/overview)                                |     v1      | Provides endpoints for embedding Adyen Capital into your marketplace or platform. | [CapitalAPI](/src/services/capital/index.ts)                                                                                                                    |
| [Cloud device API](https://docs.adyen.com/api-explorer/cloud-device-api/latest/overview)              |     v1      | Cloud device point-of-sale solution for cloud integrations. Our latest In-Person Payments integration for cloud communications.                                                                                                                                                                                                          | [CloudDeviceAPI](/src/services/clouddevice/index.ts)                                                                                                            |
...
| [Document Collector API](https://docs.adyen.com/api-explorer/Document-Collector/1/overview)                |     v1      | The Document Collector API provides endpoints for uploading documents required for cross-border invoicing.                                                                                                                                                                                                                                                       | [DocumentCollectorAPI](/src/services/documentCollector/index.ts)                                                                                                        |
| [Legal Entity Management API](https://docs.adyen.com/api-explorer/legalentity/4/overview)                  |     v4      | Manage legal entities that contain information required for verification.                                                                                                                                                                                                                                                                | [LegalEntityManagement](/src/services/legalEntityManagement/index.ts)                                                                                                   |
| [Local/Cloud-based Terminal API](https://docs.adyen.com/point-of-sale/terminal-api-reference)              |      -      | Our point-of-sale integration. For cloud communications, consider migrating to the [Cloud device API](https://docs.adyen.com/api-explorer/cloud-device-api/latest/overview) for building your In-Person Payments cloud integration.                                                                                                       | [TerminalLocalAPI](/src/services/terminalLocalAPI.ts) or [TerminalCloudAPI](/src/services/terminalCloudAPI.ts) |
...
| [Platforms APIs](https://docs.adyen.com/classic-platforms/api)                                             |      -      | Set of APIs when using Adyen for Platforms. This API is used for the classic integration.                                                                                                                                                                                                                                                | [Platforms](/src/services/platforms.ts)                                                                                                                                 |
...
| [Dispute Webhooks](https://docs.adyen.com/api-explorer/dispute-webhooks/1/overview)             | Adyen sends webhooks to inform your system about events related to disputes and chargebacks, so you can automate your dispute-handling process.                                                                                                                       | [DisputeWebhooks](src/typings/disputeWebhooks)                     | **v1**            |
| [Negative Balance Warning Webhooks](https://docs.adyen.com/api-explorer/negative-balance-warning-webhooks/1/overview)             | Adyen sends webhooks to warn you when an account holder or balance account has a negative balance that needs to be compensated.                                                                                                                       | [NegativeBalanceWarningWebhooks](src/typings/negativeBalanceWarningWebhooks)                     | **v1**            |
...
Build a feature-rich [in-person payments](https://docs.adyen.com/point-of-sale/) integration that accepts payments around the world, with global and local payment methods, and creates a unique shopping experience for your customers.

### Using the Cloud device API

For In-Person Payments cloud integrations, the recommended solution is the [Cloud device API](https://docs.adyen.com/api-explorer/cloud-device-api/1/overview).

Check the [Cloud device API README](doc/CloudDeviceApi.md).

If you are currently using the Terminal (Cloud) API, see the [migration guide](doc/MigratingToCloudDeviceApi.md).
