...
export class HKLocalAccountIdentification extends BankAccountIdentification {
    /**
    ...
    */
    ...
    static override getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HKLocalAccountIdentification.attributeTypeMap);
    }
