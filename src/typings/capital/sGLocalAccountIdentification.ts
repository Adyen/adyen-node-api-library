...
export class SGLocalAccountIdentification extends BankAccountIdentification {
    /**
    ...
    */
    ...
    static override getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SGLocalAccountIdentification.attributeTypeMap);
    }
