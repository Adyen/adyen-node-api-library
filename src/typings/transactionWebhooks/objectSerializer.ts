...
import { TransferViewCategoryDataClass } from "./transferViewCategoryData";
...
let enumsMap: Set<string> = new Set<string>([
    ...
    "TransferViewCategoryData.PriorityEnum",
    "TransferViewCategoryData.TypeEnum",
    "TransferViewCategoryData.NetworkVariantEnum",
    "TransferViewCategoryData.PanEntryModeEnum",
    "TransferViewCategoryData.ProcessingTypeEnum",
    "TransferViewCategoryData.PlatformPaymentTypeEnum",
]);
