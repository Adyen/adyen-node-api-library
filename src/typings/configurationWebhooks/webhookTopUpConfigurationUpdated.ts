...
export class WebhookTopUpConfigurationUpdated {
    ...
    */
    "status": WebhookTopUpConfigurationUpdated.StatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "WebhookTopUpConfigurationUpdated.StatusEnum",
            "format": ""
        },
        {
            "name": "topUpAmount",
    ...
    static getAttributeTypeMap() {
        return WebhookTopUpConfigurationUpdated.attributeTypeMap;
    }
...
export namespace WebhookTopUpConfigurationUpdated {
