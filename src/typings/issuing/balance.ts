...
export class Balance {
    /**
    * The remaining amount that is available for spending.
    */
    'available': number;
    /**
    * The total funds in the balance. This is the sum of the `reserved` and the `available` amounts.
    */
    'balance': number;
    /**
    ...
    */
    'currency': string;
    /**
    * The amount that is already reserved for payments that have been authorised, but have not been captured yet.
    */
    'reserved': number;
