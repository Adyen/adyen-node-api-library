...
export class CardConfiguration {
    /**
    * The Entity Reference of the card image.
    */
    'cardImageId'?: string;
    /**
    * The Entity Reference of the carrier image.
    */
    'carrierImageId'?: string;
    /**
    * The ID of the card configuration profile.
    */
    'configurationProfileId'?: string;
    /**
    * The ISO-4217 currency code for the card. For example **EUR**.
    */
    'currency'?: string;
    /**
    * The ISO-639-1 application language for the card. For example, **en**.
    */
    'language'?: string;
    /**
    * The Entity Reference of the logo image.
    */
    'logoImageId'?: string;
