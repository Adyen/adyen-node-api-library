...
*/
export class TransferEventTrackingData {
    /**
    ...
    */
    'status': TransferEventTrackingData.StatusEnum;
    /**
    * The type of the tracking event.  Possible values:   - **confirmation**: the transfer passed Adyen\'s internal review.
    */
    'type': TransferEventTrackingData.TypeEnum = TransferEventTrackingData.TypeEnum.Confirmation;
    /**
    ...
    */
    'reason'?: TransferEventTrackingData.ReasonEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "status",
            "baseName": "status",
            "type": "TransferEventTrackingData.StatusEnum"
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "TransferEventTrackingData.TypeEnum"
        },
        {
        ...
        },
        {
            "name": "reason",
            "baseName": "reason",
            "type": "TransferEventTrackingData.ReasonEnum"
        }    ];

    static getAttributeTypeMap() {
        return TransferEventTrackingData.attributeTypeMap;
    }
}

export namespace TransferEventTrackingData {
