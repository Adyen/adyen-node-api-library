...
export namespace ModificationResult {
    export type ResponseEnum = '[capture-received]' | '[cancel-received]' | '[refund-received]' | '[cancelOrRefund-received]';
    export const ResponseEnum = {
        CaptureReceived: '[capture-received]' as ResponseEnum,
        CancelReceived: '[cancel-received]' as ResponseEnum,
        RefundReceived: '[refund-received]' as ResponseEnum,
        CancelOrRefundReceived: '[cancelOrRefund-received]' as ResponseEnum
    };
}