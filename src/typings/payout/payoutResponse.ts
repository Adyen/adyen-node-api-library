...
export namespace PayoutResponse {
    export type ResultCodeEnum = 'Authorised' | 'PartiallyAuthorised' | 'Refused' | 'Error' | 'Cancelled' | 'Received' | 'RedirectShopper';
    export const ResultCodeEnum = {
        Authorised: 'Authorised' as ResultCodeEnum,
        PartiallyAuthorised: 'PartiallyAuthorised' as ResultCodeEnum,
