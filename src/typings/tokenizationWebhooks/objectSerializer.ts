...
import { TokenizationCreatedDetailsNotificationRequest } from "./tokenizationCreatedDetailsNotificationRequest";
import { TokenizationDisabledDetailsNotificationRequest } from "./tokenizationDisabledDetailsNotificationRequest";
import { TokenizationNotificationResponse } from "./tokenizationNotificationResponse";
import { TokenizationUpdatedDetailsNotificationRequest } from "./tokenizationUpdatedDetailsNotificationRequest";
...
let enumsMap: Set<string> = new Set<string>([
    "TokenizationAlreadyExistingDetailsNotificationRequest.EnvironmentEnum",
    "TokenizationAlreadyExistingDetailsNotificationRequest.TypeEnum",
    "TokenizationCreatedDetailsNotificationRequest.EnvironmentEnum",
    "TokenizationCreatedDetailsNotificationRequest.TypeEnum",
    "TokenizationDisabledDetailsNotificationRequest.EnvironmentEnum",
    "TokenizationDisabledDetailsNotificationRequest.TypeEnum",
    "TokenizationUpdatedDetailsNotificationRequest.EnvironmentEnum",
    "TokenizationUpdatedDetailsNotificationRequest.TypeEnum",
]);

let typeMap: {[index: string]: any} = {
    "RecurringToken": RecurringToken,
    "RecurringTokenStoreOperation": RecurringTokenStoreOperation,
