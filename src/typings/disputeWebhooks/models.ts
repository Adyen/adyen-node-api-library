...
import { DisputeNotificationRequest } from './disputeNotificationRequest';
...
let enumsMap: {[index: string]: any} = {
        "DisputeEventNotification.TypeEnum": DisputeEventNotification.TypeEnum,
        "DisputeNotificationRequest.TypeEnum": DisputeNotificationRequest.TypeEnum,
}

let typeMap: {[index: string]: any} = {
    "Amount": Amount,
    "BalancePlatformNotificationResponse": BalancePlatformNotificationResponse,
    "DisputeEventNotification": DisputeEventNotification,
