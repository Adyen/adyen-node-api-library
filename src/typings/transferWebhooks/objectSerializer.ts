...
import { BankAccountV3AccountIdentificationClass } from "./bankAccountV3AccountIdentification";
...
let enumsMap: Set<string> = new Set<string>([
    ...
    "TransferDataCategoryData.PriorityEnum",
    "TransferDataCategoryData.TypeEnum",
    "TransferDataCategoryData.NetworkVariantEnum",
...
let typeMap: {[index: string]: any} = {
    ...
    "BankAccountV3AccountIdentification": BankAccountV3AccountIdentificationClass,
