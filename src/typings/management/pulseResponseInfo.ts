...
export class PulseResponseInfo {
    /**
    ...
    */
    "processingType": PulseResponseInfo.ProcessingTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "PulseResponseInfo.ProcessingTypeEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return PulseResponseInfo.attributeTypeMap;
    }
...
export namespace PulseResponseInfo {
