...
export class NyceResponseInfo {
    ...
    */
    "processingType": NyceResponseInfo.ProcessingTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "NyceResponseInfo.ProcessingTypeEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return NyceResponseInfo.attributeTypeMap;
    }
...
export namespace NyceResponseInfo {
