...
export class AccelResponseInfo {
    /**
    ...
    */
    "processingType": AccelResponseInfo.ProcessingTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "AccelResponseInfo.ProcessingTypeEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return AccelResponseInfo.attributeTypeMap;
    }
...
export namespace AccelResponseInfo {
