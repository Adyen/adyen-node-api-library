...
import { VerificationError } from "../../typings/legalEntityManagement/models";
...
export class LegalEntitiesApi extends Service {
    ...
    */
    public async getLegalEntity(id: string, requestOptions?: IRequest.Options): Promise<LegalEntity> {
        const localVarPath = "/legalEntities/{id}"
    ...
    */
    public async getAllBusinessLinesUnderLegalEntity(id: string, requestOptions?: IRequest.Options): Promise<BusinessLines> {
        const localVarPath = "/legalEntities/{id}/businessLines"
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new LegalEntityManagementResource(this, localVarPath);
    ...
    */
    public async createLegalEntity(legalEntityInfoRequiredType: LegalEntityInfoRequiredType, requestOptions?: IRequest.Options): Promise<LegalEntity> {
        const localVarPath = "/legalEntities";
        const resource = new LegalEntityManagementResource(this, localVarPath);
    ...
    * @param id {@link string } The unique identifier of the legal entity.
    * @param requestOptions {@link IRequest.Options}
    * @return {@link VerificationError }
    */
    public async checkLegalEntitysVerificationErrors(id: string, requestOptions?: IRequest.Options): Promise<VerificationError> {
        const localVarPath = "/legalEntities/{id}/checkVerificationErrors"
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new LegalEntityManagementResource(this, localVarPath);
        const response = await getJsonResponse<string, VerificationError>(
            resource,
            "",
            { ...requestOptions, method: "POST" }
        );
