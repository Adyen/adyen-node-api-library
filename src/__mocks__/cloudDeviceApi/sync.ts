...
export const syncResponseRefund = {
    SaleToPOIResponse: {
        MessageHeader: {
            MessageCategory: "Payment",
            MessageClass: "Service",
...
export const syncResponseEventNotificationWithAdditionalAttributes = {
   "SaleToPOIRequest":{
      "EventNotification":{
...
export const syncResponseEventNotificationWithUnknownEnum = {
   "SaleToPOIRequest":{
      "EventNotification":{
         "EventDetails":"newstate=IDLE&oldstate=START",
